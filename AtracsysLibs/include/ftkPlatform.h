...
// C/C++ struct management (+ packing)
    ...
    struct x
            ...
            ///  Portable (C/C++) packed struct declaration endig
    ...
    __pragma( pack( pop ) )
            ...
            #if _MSC_VER >= 1912
            #define PACK1_STRUCT_BEGIN_DEPRECATED( x ) __declspec(deprecated) __pragma( pack( push, 1 ) ) \
                struct x
            #else
            #define PACK1_STRUCT_BEGIN_DEPRECATED( x ) __pragma(message( "Deprecated structure" )) \
    ...
    _Pragma( "pack(pop)" )
        #endif // PACK1_STRUCT_END
        #ifndef PACK1_STRUCT_BEGIN_DEPRECATED
            #define PACK1_STRUCT_BEGIN_DEPRECATED( x ) _Pragma( "pack(push, 1)" ) \
                struct x
        #endif // PACK1_STRUCT_BEGIN_DEPRECATED
        #ifndef PACK1_STRUCT_END_DEPRECATED
            #define PACK1_STRUCT_END_DEPRECATED( x ) __attribute__((deprecated)); \
                _Pragma( "pack(pop)" )
        #endif // PACK1_STRUCT_END_DEPRECATED
